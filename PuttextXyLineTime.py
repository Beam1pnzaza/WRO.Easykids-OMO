...
def DetectRed(frame):
    ...
    if len(red_contours) > 0:
        ...
        return 0, -1  # Return 0 area and -1 if no red detected

def DetectGreen(frame):
    lowergreen = np.array([42, 36, 136])
    ...
    if len(green_contours) > 0:
        ...
        return 0, -1  # Return 0 area and -1 if no green detected
...
while True:
    ...
    # Detect and draw red and green contours with area > 5000
    red_area, red_center_x = DetectRed(frame)
    green_area, green_center_x = DetectGreen(frame)
    ...
    if red_center_x != -1 and red_area > 5000:
        if red_center_x < x1:
    ...
    if green_center_x != -1 and green_area > 5000:
