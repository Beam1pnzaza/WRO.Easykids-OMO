...
![367930913_820224116414765_2923383908170852393_n-removebg-preview](https://github.com/Beam1pnzaza/WRO.Easykids-OMO/assets/86812911/84b93f68-f98e-4bb7-be68-1e79328a1f72)
...
During the development journey of our robot for the WRO competition, we encountered an array of challenges that demanded meticulous analysis and innovative solutions. In the initial phases of designing both the robot's structure and code, we grappled with issues pertaining to stability and precision. The pursuit of our compact and stable design necessitated careful calibration of sensors and actuators, ensuring flawless movement and accurate color detection. Over weeks 1 and 2, our focus centered on rectifying these concerns by refining the physical structure and optimizing code performance.

Transitioning into weeks 3 and 4, our focus shifted to perfecting the color detection algorithm. Initial HSV values captured by the camera proved insufficiently accurate for precise color recognition. Our solution involved an iterative approach, integrating a secondary code with slide bars. By fine-tuning the HSV values, we honed color detection until only the desired shades remained, guaranteeing the robot's adeptness at recognizing cones.

With satisfactory color detection in place, weeks 5 and 6 revolved around rigorous testing. Our evaluation process encompassed diverse settings, lighting scenarios, and cone distances. We simulated real-world conditions by placing cones at varying angles and positions, unveiling further challenges tied to fluctuating lighting and calibration disparities.

To counter these obstacles, we persistently optimized the code and calibration parameters, enabling adaptability to diverse lighting conditions and sustaining precision. We also refined the robot's motion, utilizing advanced techniques to ensure swift and assured turns, pivotal for navigating the competition arena efficiently.

Testing emerged as the bedrock of our iterative problem-solving process. Weeks 7 and 8 were dedicated to meticulously documenting testing procedures, results, and the corresponding solutions. Performance metrics enabled quantitative assessment of color detection accuracy and motion control efficacy.
